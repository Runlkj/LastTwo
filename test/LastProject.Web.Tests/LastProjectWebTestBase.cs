...
using LastProject.Models.TokenAuth;
...
{
    public abstract class LastProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LastProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LastProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LastProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LastProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LastProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LastProjectDbContext, Task<T>> func)
        {
            T result;
